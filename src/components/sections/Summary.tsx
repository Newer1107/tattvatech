...
export function Summary() {
  ...
  return (
    ...
    >
      <div className="h-full overflow-hidden rounded-[32px] border border-[rgba(16,24,40,0.08)] bg-[linear-gradient(180deg,rgba(255,255,255,0.94)_0%,rgba(252,251,249,0.98)_100%)] shadow-[0_30px_80px_rgba(16,24,40,0.08)]">
